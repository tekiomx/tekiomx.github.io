          ...
          <div className="grid md:grid-cols-3 gap-12">
            <div className="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-200">
              ...
              <p className="text-gray-600">
                Somos expertos en ensamblar cualquier tipo de mueble, desde
                escritorios hasta libreros
              </p>
            </div>
            <div className="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-200">
              <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mb-6">
              ...
              <p className="text-gray-600">
                Colgamos cuadros, repisas y todo lo que necesites para decorar
                tu espacio
              </p>
            </div>
            <div className="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-200">
              ...
              <p className="text-gray-600">
                Solucionamos pequeños problemas del hogar para mantener tu
                espacio perfecto
              </p>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  <CheckCircle2 className="h-6 w-6 text-blue-600 mt-1 mr-4" />
                  <div>
                    <h3 className="font-semibold text-lg text-gray-900">
                      Expertos Confiables
                    </h3>
                    <p className="text-gray-600">
                      Todos nuestros técnicos son profesionales capacitados y de
                      confianza
                    </p>
                  </div>
                </div>
            ...
            <div className="relative">
              <img
                src="https://realestatemarket.com.mx/images/2020/08_Agosto/0808/Como_hacer_un_plan_de_mantenimiento_para_tu_casa___.jpg"
      ...
      <section className="bg-blue-600 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            En Tekio creemos que todas las personas merecen vivir en un espacio
            que les inspire y les de paz
          </p>
          <a
            href="https://docs.google.com/forms/d/e/1FAIpQLSfMGD6zLWUYT95j6M96pWk3OUK0TgFL8igRfIOeW6yCwr_0kQ/viewform"
            target="_blank"
