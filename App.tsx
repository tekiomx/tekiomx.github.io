            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="font-semibold text-lg text-gray-900">Expertos Verificados</h3>
                    <p className="text-gray-600">Todos nuestros técnicos son profesionales capacitados y de confianza</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <CheckCircle2 className="h-6 w-6 text-blue-600 mt-1 mr-4" />
